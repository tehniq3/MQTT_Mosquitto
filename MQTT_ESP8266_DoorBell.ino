...
//########################################################################
// https://github.com/ElectronHacks/ESP8266_MQTT_DoorBell
...
char server[]       = "192.168.1.106";       // MQTT Server IP or machine name (example 192.168.1.106)
...
char mQTTUser[]     = "";                 // MQTT UserName (See below for modification if you don't use user and password)
char mQTTPassword[] = "";                 // MQTT Password (See below for modification if you don't use user and password)

char* lightTopic = "/test/light1";
// Callback function header
void callback(char* topic, byte* payload, unsigned int length);  // https://github.com/ItKindaWorks/ESP8266/issues/7

WiFiClient wifiClient;
PubSubClient client(server, 1883, callback, wifiClient);

byte ledtest = 2; // blue led onn NodeMCU (D4)
